...
//
// Desktop-only — the two glow orbs are `hidden md:block`, no gradient renders on mobile at
// all. iOS Safari has a real bug where `position: fixed` + `mix-blend-mode` children
...
export default function BackgroundGradient() {
  ...
  return (
    ...
    >
      <div
        className="absolute -inset-[20%] hidden motion-safe:animate-[drift-a_18s_ease-in-out_infinite] md:block"
        style={{
          background:
      ...
      />
      <div
        className="absolute -inset-[20%] hidden motion-safe:animate-[drift-b_23s_ease-in-out_infinite] md:block"
        style={{
          background:
